...
class Niveau:
    ...
    def afficher(self, fenetre):
        ...
        for ligne in self.structure:
            ...
            num_case = 0
            for bloc in ligne:
                x = num_case*constante.taille_block
                y = num_ligne*constante.taille_block
                if bloc == 'd':          
...
class MyHero(MySprite):
        ...
        def movement(self,surrondings):
            ...
            if keys[pygame.K_RIGHT] and self.rect.right < constante.width and (surrondings[3]=='0' or surrondings[3]=='\n'):
            ...
            if keys[pygame.K_DOWN] and self.rect.bottom < constante.height and (surrondings[2]=='0' or surrondings[2]=='\n'):
                self.set_image("centre")
                self.rect = self.rect.move(0, 5)
